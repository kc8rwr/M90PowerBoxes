...
module power_switch_box(angle=45, corner=5, edge=2, device="RLEIL_R2", device_space_z=4, device_space_y=4, fastener_spacing=100, fastener_size="#6", cable_d=7.5, cable_bolt="M3", body_color="Blue", support_color="Yellow", support_skin=0.6, max_skinless_angle=50, wall=2){
